...
// RegisterStagesSvicHandlerClient registers the http handlers for service StagesSvic
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "StagesSvicClient".
